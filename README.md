...
> [!TIP]
> To deploy this project using **GUI-based flow**, navigate to [console](https://console.stacktape.com/create-new-project/git-project-using-console?name=my-stacktape-app&repositoryType=public&repositoryUrl=https://github.com/stacktape/starter-sveltekit-serverless)

- Server-side rendered [SvelteKit](https://kit.svelte.dev/) application deployed serverlessly.
- Uses the purpose-built [SvelteKit web resource](https://docs.stacktape.com/compute-resources/sveltekit-website/) that
  runs the app in AWS Lambda with static assets on CloudFront CDN. Zero infrastructure configuration needed.
...
```bash
stacktape init --starterId sveltekit-serverless
```
